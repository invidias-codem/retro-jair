...
const BishopChat = () => {
    ...
    useEffect(() => {
        ...
        const initializeChat = async () => {
            ...
            try {
                // Use a capable model (Flash is likely fine, but ensure it handles nuance)
                ...
                const newChat = model.startChat({
                    ...
                    // Slightly lower temperature for potentially more focused/less divergent responses
                    generationConfig: { temperature: 0.6, topK: 40, topP: 0.9, maxOutputTokens: 4096 },
                    // CRITICAL: Maintain strong safety settings
                    safetySettings: [
